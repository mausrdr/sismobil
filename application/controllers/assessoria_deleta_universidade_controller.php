...
class Assessoria_deleta_universidade_controller extends MY_controller {
    ...
    public function form() {
        ...
        $data['titulo'] = "Deletar Universidade";
        
        $this->view_data['paragrafo'] = "Por favor, busque a Universidade que você deseja deletar";
        ...
        $this->view_data['url'] = "index.php/assessoria_deleta_universidade_controller";
        
        $this->view_data['legend'] = "Deletar Universidade";
        ...
        if($this->form_validation->run() == FALSE) {
            ...
            $data['titulo'] = "Confirmar Dados da Remoção da Universidade";
            
            $this->view_data['h1'] = "Confirmar remoção da Universidade";
            
            $this->view_data['paragrafo'] = "Por favor confira se os dados estão corretos";
            
            $this->view_data['url'] = "index.php/assessoria_deleta_universidade_controller/deletar";
    ...
    public function deletar() {
        ...
        $resultado = $this->universidade_dao->deleteUniversidade($universidade);
        
        if($resultado) {
            
            $data['titulo'] = "Sucesso!!!";
            
            $this->view_data['mensagem_h3'] = "A Remoção da ". $descricao_universidade . " foi realizada com sucesso!!";
            $this->view_data['mensagem_h4'] = "Para deletar outra Universidade, <a href=\"". base_url() . "index.php/assessoria_deleta_universidade_controller\">clique aqui.</a>";
            ...
            $this->view_data['mensagem_h3'] = "A remoção da " .$descricao_universidade. " falhou!! Verifique se os dados foram informados de forma correta e <a href=\"" . base_url() . "index.php/assessoria_deleta_universidade_controller\">tente novamente.</a>";
