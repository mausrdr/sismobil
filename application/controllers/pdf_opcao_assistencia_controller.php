...
class Pdf_opcao_assistencia_controller extends MY_controller {
    ...
    function __construct() {
        ...
        $this->load->model('ficha_curso_has_edital_curso_to');
        $this->load->model('ficha_curso_has_edital_curso_dao');
...
// add a page
        ...
        $mobilidade = new Ficha_curso_has_edital_curso_to();
        $mobilidade->setFicha_curso_id_ficha_curso($this->ficha_dao->getIdFichaCurso($fc->getFicha_id_ficha()));
            
        $id_edital_has_curso = $this->ficha_curso_has_edital_curso_dao->getIdsEditalHasCurso($mobilidade->getFicha_curso_id_ficha_curso());

        $edital_has_curso = new Edital_has_curso_to();

        $universidade = array();
        $campus_universidade = array();
        $curso_universidade = array();

        $i = 0;

        foreach ($id_edital_has_curso as $id_edital) {

            $edital_has_curso = $this->edital_has_curso_dao->getEditalHasCurso($id_edital);

            $universidade[$i] = $this->universidade_dao->getDescricaoUniversidade($edital_has_curso->getUniversidade_id_universidade());
            $campus_universidade[$i] = $this->campus_universidade_dao->getDescricaoCampus($edital_has_curso->getCampus_universidade_id_campus_universidade());
            $curso_universidade[$i] = $this->curso_universidade_dao->getDescricaoCurso($edital_has_curso->getCurso_universidade_id_curso_universidade());
        ...
        <tr style="border-collapse: collapse;border: 1px solid black;">
         ...
         <tr style="border-collapse: collapse;border: 1px solid black;">
            ...
            <td> <br /><br />'. $universidade[0] .' - '. $campus_universidade[0] .'</td>
         </tr>
         <tr style="border-collapse: collapse;border: 1px solid black;">
            <td style="height:30px;border: 1px solid black;"> <b><br />Curso:</b></td>
            <td> <br /><br />'. $curso_universidade[0] .'</td>
         </tr>
         <tr style="border-collapse: collapse;border: 1px solid black;">
            <td style="width:190px;border: 1px solid black;"> <b><br />Universidade de Destino:</b></td>
            <td> <br /><br />'. $universidade[1] .' - '. $campus_universidade[1] .'</td>
         </tr>
         <tr style="border-collapse: collapse;border: 1px solid black;">
            <td style="height:30px;border: 1px solid black;"> <b><br />Curso:</b></td>
            <td> <br /><br />'. $curso_universidade[1] .'</td>
         </tr>
         <tr style="border-collapse: collapse;border: 1px solid black;">
            <td style="width:190px;border: 1px solid black;"> <b><br />Universidade de Destino:</b></td>
            <td> <br /><br />'. $universidade[2] .' - '. $campus_universidade[2] .'</td>
         </tr>
         <tr style="border-collapse: collapse;border: 1px solid black;">
            <td style="height:30px;border: 1px solid black;"> <b><br />Curso:</b></td>
            <td> <br /><br />'. $curso_universidade[2] .'</td>
         </tr>
         </table>
         <p></p>
         <table border="0" cellpadding="4">
...
// create some HTML content
        ...
        $html = '<h1>4 - Conhecimentos Lingüísticos</h1>
         <table border="0" cellpadding="4">
            <tr>
        ...
        $html .= '<h1>5 - Carta de Motivação</h1>';

// output the HTML content
        $this->pdf->writeHTML($html, true, false, true, false, '');

        $this->pdf->write(6, $carta_motivacao, '', 0, 'J', true, 0, false, false);
...
// create some HTML content
        ...
        $html = '<h1>6 - Carta de Recomendação de um professor do curso do candidato</h1>
            <p style="text-align: justify; border-style: solid solid solid solid; border-width: 1px;">Exponha por que o referido candidato é merecedor da indicação para o programa de mobilidade:<br />
            <br /><b>Data:<br />
            Assinatura do professor, com firma reconhecida em cartório:</b>
...
// create some HTML content
        ...
        $html = '<h1>7 – Aceite de um professor orientador durante o intercambio do aluno:</h1>
            <p style="line-height: 0.08cm; text-align: justify; border-style: solid solid solid solid; border-width: 1px;"><br /><br />Eu, _______________________________________________________________________________, professor do curso
            _____________________________________________, do campus _____________________,
            SIAPE: _________________, CPF: _______________________, aceito ser orientador do
            referido bolsista, durante seu intercâmbio, me comprometendo a acompanhar suas atividades
            realizadas no exterior, bem como emitir parecer final, ao seu retorno.<br />
            <b>Data:<br />
            Assinatura do professor orientador, com firma reconhecida em cartório:</b>
            <br /><br /><br /><br /><br /><br />
            </p>';
...
// create some HTML content
        ...
        $html = '<p></p>
            <h1>8 - Atividades Extracurriculares</h1>';
...
// create some HTML content
        $html = '<h1>9 - Condições</h1>
            ...
            <h1>10 - Termo de Responsabilidade</h1>
            <p></p>
            ';
