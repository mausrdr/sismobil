...
class Dados_pessoais_opcao_controller extends MY_controller {
    ...
    public function form($cpf, $id_edital) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('dados_pessoais_opcao_view', $this->view_data);
            ...
            $this->load->view('dados_pessoais_opcao_confirm_view', $this->view_data);
    ...
    function seguinte() {
        ...
        redirect("pdf_opcao_controller/index/$id");
