...
class Assessoria_deleta_campus_controller extends MY_controller {
    ...
    public function form() {
        ...
        $data['titulo'] = "Deletar Câmpus";
        
        $this->view_data['paragrafo'] = "Por favor, busque o Câmpus que você deseja deletar";
        ...
        $this->view_data['url'] = "index.php/assessoria_deleta_campus_controller";
        
        $this->view_data['legend'] = "Deletar Câmpus";
        ...
        $this->view_data['content'] = "Buscar Campus";
        ...
        if($this->form_validation->run() == FALSE) {
            ...
            $data['titulo'] = "Confirmar Dados da Remoção do Câmpus";
            
            $this->view_data['h1'] = "Confirmar remoção do Câmpus";
            
            $this->view_data['paragrafo'] = "Por favor confira se os dados estão corretos";
            
            $this->view_data['url'] = "index.php/assessoria_deleta_campus_controller/deletar";
    ...
    public function deletar() {
        ...
        $resultado = $this->campus_universidade_dao->deleteCampus($campus);
        
        if($resultado) {
            
            $data['titulo'] = "Sucesso!!!";
            
            $this->view_data['mensagem_h3'] = "A Remoção do ". $descricao_campus . " foi realizada com sucesso!!";
            $this->view_data['mensagem_h4'] = "Para deletar outro Câmpus, <a href=\"". base_url() . "index.php/assessoria_deleta_campus_controller\">clique aqui.</a>";
            ...
            $this->view_data['mensagem_h3'] = "A remoção do " .$descricao_campus. " falhou!! Verifique se os dados foram informados de forma correta e <a href=\"" . base_url() . "index.php/assessoria_deleta_campus_controller\">tente novamente.</a>";
