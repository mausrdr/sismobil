...
class Assessoria_restaura_senha_controller extends MY_controller {
    ...
    public function index() {
        ...
        $vals = array(
            'word'          =>  $this->geraWord(),
            'img_path'      =>  '/var/www/html/sismobil/captcha/',
        ...
        $this->view_data['url'] = "index.php/assessoria_restaura_senha_controller";
        ...
        if($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('assessoria_restaura_senha_view', $this->view_data);
            ...
            $dados = $this->pessoas_dao->getNomeIdRestaura($email);
            ...
            $token->setPessoas_id_pessoas($dados['id_pessoas']);
            
            if($this->token_pessoas_dao->insertToken($token)) {
                
                $this->email->from('sismobil@ifsuldeminas.edu.br', 'Assessoria Internacional');
                $this->email->to($email);
                $this->email->subject('Restaurar senha - IFSULDEMINAS');
                $corpo =   "<html>
                                <meta charset=\"utf-8\">
                                <body style=\"text-align: center; background-color: #e7efd1;\">
                                    ...
                                    <p style=\"color: #000000; text-align: justify; font-size: 12pt; font-family: ubuntu;\">
                                        ...
                                        Conforme solicitado resetamos sua senha. Por medida de segurança, não enviamos senha por e-mail. Você tem 24 horas para clicar no link abaixo para criar sua nova senha: <br/>
                                        " . anchor('http://localhost/sismobil/index.php/assessoria_nova_senha_controller/index/' . $token->getCodigo(), 'Recuperar senha') . "<br/>
                                        Caso você ultrapasse as 24 horas, faça a novamente a solicitação de restauração de sua senha.<br/>
                                        Atenciosamente,
                                    </p>
                                    <p style=\"color: #000000; text-align: justify; font-size: 12pt; font-family: ubuntu;\">
                ...
                $this->view_data['mensagem_h4'] = "Acesse sua conta de email para restaurar sua senha.<br/> <a href=\"". base_url() . "index.php/main_controller\">Clique aqui</a> para retornar a página principal.";
    ...
    public function validaEmail($email) {
        ...
        if($this->pessoas_dao->emailExiste($email)) {
