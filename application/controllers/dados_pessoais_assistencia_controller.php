...
class Dados_pessoais_assistencia_controller extends MY_controller {
    ...
    public function form($cpf, $id_edital) {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('dados_pessoais_assistencia_view', $this->view_data);
            ...
            $financiamento->setId_tipo_financiamento($this->input->post('id_financiamento'));
            ...
            $this->view_data['url'] = "index.php/dados_pessoais_assistencia_controller/registrar";
    ...
    public function registrar() {
        ...
        $ficha_candidatura->setBic(0);
        $ficha_candidatura->setPvpp(0);
        $ficha_candidatura->setPo(0);
        $ficha_candidatura->setEstagio(0);
        $ficha_candidatura->setEcc(0);
        ...
        $this->view_data['url'] = "index.php/dados_pessoais_assistencia_controller/seguinte";
    ...
    function seguinte() {
        ...
        redirect("pdf_assistencia_controller/index/$id");
