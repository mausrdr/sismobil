...
<!--[if gt IE 8]><!--> <html lang="pt-BR" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <script>
            ...
            function confirma(op,desc) {
                
                switch(op) {
                    case 0:
                        var confirmar = confirm("Você realmente deseja excluir o edital número " + desc + "?\nSe clicar em OK o registro será removido e esta ação não poderá ser revertida!\nCaso não queira remover o registro clique em Cancelar!");
                        break;
                    case 1:
                        var confirmar = confirm("Você realmente deseja excluir a " + desc + "?\nSe clicar em OK o registro será removido e esta ação não poderá ser revertida!\nCaso não queira remover o registro clique em Cancelar!");
                        break;
                    case 2:
                        var confirmar = confirm("Você realmente deseja excluir o " + desc + "?\nSe clicar em OK o registro será removido e esta ação não poderá ser revertida!\nCaso não queira remover o registro clique em Cancelar!");
                        break;
                    case 3:
                        var confirmar = confirm("Você realmente deseja excluir o curso " + desc + "?\nSe clicar em OK o registro será removido e esta ação não poderá ser revertida!\nCaso não queira remover o registro clique em Cancelar!");
                        break;
                    case 4:
                        var confirmar = confirm("Você realmente deseja excluir o item da Matriz de Vagas referente ao edital número " + desc + "?\nSe clicar em OK o registro será removido e esta ação não poderá ser revertida!\nCaso não queira remover o registro clique em Cancelar!");
                        break;
                    case 5:
                        var confirmar = confirm("Você realmente deseja excluir o item da Matriz de Cursos Ofertados referente ao edital número " + desc + "?\nSe clicar em OK o registro será removido e esta ação não poderá ser revertida!\nCaso não queira remover o registro clique em Cancelar!");
                        break;
                }
                ...
                if(confirmar) {
                    ...
                    switch(op) {
                        case 0:
                            location.href = "../index.php/assessoria_deleta_edital_controller";
                            break;
                        case 1:
                            location.href = "../index.php/assessoria_deleta_universidade_controller";
                            break;
                        case 2:
                            location.href = "../index.php/assessoria_deleta_campus_controller";
                            break;
                        case 3:
                            location.href = "../index.php/assessoria_deleta_curso_controller";
                            break;
                        case 4:
                            location.href = "../../../index.php/assessoria_deleta_matriz_vagas_controller";
                            break;
                        case 5:
                            location.href = "../../../index.php/assessoria_deleta_matriz_curso_controller";
                            break;
                    }
        ...
        <link rel="stylesheet" href="<?php echo base_url(); ?>css/estilo_confirm.css" type="text/css" title="padrao" />
