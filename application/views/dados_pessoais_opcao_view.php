...
<!--[if gt IE 8]><!--> <html lang="pt-BR" class="no-js"> <!--<![endif]-->
    ...
    <body onload="drop_down()">
        ...
        echo form_open($base_url . "index.php/dados_pessoais_opcao_controller/index/?cpf=$ncpf&id=$id_edital", $atributos);
        ...
        <fieldset>
            ...
            <ol>
                <li>
                    ...
                    <div class="styled-select">
                        <?php echo form_dropdown('financiamento', $options_financiamento, set_value('financiamento'), 'required'); ?>
                    </div> <br />
                    <?php echo form_button(array('type' => 'submit', 'onclick' => 'adicionaFinanciamento()' , 'content' => 'Adicionar outra forma de financiamento')); ?>
                </li>
            </ol>
        </fieldset>
        <fieldset>
