...
<html>
    ...
    <body>
        ...
        echo form_open($base_url . "index.php/dados_pessoais_opcao_assistencia_controller/registrar");
        ...
        $dados = array(
            ...
            'id_edital_has_curso1'  =>      $opcao1,
            'id_edital_has_curso2'  =>      $opcao2,
            'id_edital_has_curso3'  =>      $opcao3,
        ...
        <table>
            ...
            <?php
                ...
                for($i = 0; $i < 3; $i++) {
                    ...
                    echo '<tr>';
                    echo '<td>';
                    echo $i + 1 .'ª Opção de Universidade</td>';
                    echo '<td>';
                    echo $desc_opcao[$i][$univ_post_str] .'</td>';
                    echo '</tr>';
                    echo '<tr>';
                    echo '<td>';
                    echo $i + 1 .'ª Opção de Câmpus</td>';
                    echo '<td>';
                    echo $desc_opcao[$i][$camp_post_str] .'</td>';
                    echo '</tr>';
                    echo '<tr>';
                    echo '<td>';
                    echo $i + 1 .'ª Opção de Curso</td>';
                    echo '<td>';
                    echo $desc_opcao[$i][$curso_post_str] .'</td>';
                    echo '</tr>';
